...
def app():
    ...
    st.title('Card Symbol Classification')
    st.subheader('Edited by Princes Rose Manuel, WVSU College of ICT')
    st.subheader('Original code by Louie F. Cervantes M.Eng., WVSU College of ICT')
    ...
    st.write('Image recognition research: Studying image classification techniques and algorithms.')
    st.write("""Pattern recognition: Identifying patterns in card symbols for various analysis and applications.""")
